...
int main()
{
    const int array[3] = {1, 2, 3};                        // Allocate memory for five elements of type int and initialize each element with the corresponding value.
    ...
    for (int i = 0; i < sizeof(array) / sizeof(int); ++i) // Iterate through the array.
    {
